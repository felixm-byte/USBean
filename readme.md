...
I made this since I've always struggled with organising cables for peripherals on my desk, and also thought having a simple second display is really useful for displaying data, like a timer, without interrupting the important tasks on the main display. It's a bean because beans are both our friends and very useful to us, just like this will be. 
## Features
...
Assemble the PCB or use a PCBA service like JLCPCB (recommended due to small part sizes).
